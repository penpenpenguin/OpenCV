...
key = '5b8a72d8676d4e0782389dd8832f00c9'
gid = 'gp01'
...
def setting():
    ...
    blank = ttk.Label(stmain_frame, text = "", style = 'Blank.TLabel').pack(fill = 'x')
    stlabel = ttk.Label(stmain_frame, text = "設定", justify = CENTER, style = 'Title.TLabel').pack()
    blank2 = ttk.Label(stmain_frame, text = "", style = 'Blank.TLabel').pack(fill = 'x')
...
style = ttk.Style()
style.configure('TButton', font=("微軟正黑體", 12, 'bold'), foreground = '#696969', background = '#f8f8ff')
style.configure('TLabel', font=("微軟正黑體", 12, 'bold'), foreground = '#696969', background = '#f8f8ff')
style.configure('TFrame', background = '#f8f8ff')
style.configure('Title.TLabel', font=("微軟正黑體", 50, 'bold'), foreground = '#696969', background = '#f8f8ff')
style.configure('Blank.TLabel', font=("Gill Sans MT", 12, 'bold', 'italic'), foreground = '#f8f8ff', background = '#696969')
